...
#define RCMX1_FIMRWARE_VERSION      0x13
...
#define RC_SERVO_FILTER_ON          1

// Bit values for register 0xA1 Analog Input GPIO Direction
#define ANALOG_DIRECTION_OUTPUT     1
#define ANALOG_DIRECTION_INPUT      0

// These values are what the user writes into register 0xA4 Analog Input Enable
#define ANALOG_ENABLE_REGISTER_BIT_ENABLE   0
...
// Default (boot up) value in the Safety Timeout Register (in seconds)
#define DEFAULT_SAFETY_TIMEOUT_S    0
